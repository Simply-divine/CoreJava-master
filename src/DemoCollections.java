...
public class DemoCollections {
	...
	public static void main (String[] args) {
		LinkedList<Std> data = new LinkedList<>();
		data.add(new Std(1, "Sumit"));
		data.add(new Std(2, "Sumit"));
		data.add(new Std(3, "Sumit"));
		data.add(new Std(4, "Sumit"));
		data.add(new Std(5, "Sumit"));
